      ...
      {accordionData.map((accordionItem, index) => (
        ...
        >
          <h2 className="accordion-item--heading mb-0">
            <button
              className="group relative flex w-full font-semibold items-center rounded-t-lg border-0 bg-white-900/20 py-4 px-5 text-left text-transparent bg-clip-text bg-gradient-to-b from-neutral-100 to-neutral-500"
              type="button"
